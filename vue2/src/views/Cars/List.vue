            ...
            <v-container v-else class="my-2">
                <form @submit.prevent="addCars" autocomplete="off">
                    ...
                    <v-flex xs12 lg2 xl2 md3 sm4>
                        <v-text-field v-model="cars.car_name" type="text" :label="$store.getters.language.data.cars.car_name" dense
                            class="mx-1"  filled outlined  required>
                        </v-text-field>
                    </v-flex>
                
                    <v-flex xs12 lg2 xl2 md3 sm4>
                        <v-text-field v-model="cars.car_model" type="text" :label="$store.getters.language.data.cars.car_model" dense
                            class="mx-1"  filled outlined >
                        </v-text-field>
                    </v-flex>
                    <v-flex xs12 lg2 xl2 md3 sm4>
                        <v-text-field v-model="cars.car_year" type="text" :label="$store.getters.language.data.cars.car_year" dense
                            class="mx-1"  filled outlined >
                        </v-text-field>
                    </v-flex>
                    <v-flex xs12 lg2 xl2 md3 sm4>
                        <v-text-field v-model="cars.car_note" type="text" :label="$store.getters.language.data.cars.car_note" dense
                            class="mx-1"  filled outlined >
                        </v-text-field>
                    </v-flex>
                        <v-flex xs12 lg2 xl2 md3 sm4>
